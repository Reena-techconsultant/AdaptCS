...
const TermsSection = () => {
  return (
    <>
      ...
      <div className="max-w-[85rem] px-4 mt-8 sm:px-6 lg:px-8 sm:pb-20 mx-auto text-gray-600 body-font">
        <p>Last Modified: January 11, 2017</p>
        <h1 className="pb-2 pt-2 text-lg font-medium text-gray-900 text-white">
          Acceptance of the Terms of Use
        </h1>
        <p className="leading-relaxed text-base pb-3">
          These terms of use are entered into by and between You and Adapta
          Management Limited ("<b>Company</b>", "<b>we</b>" or "<b>us</b>"). The
          following terms and conditions govern your access to and use of
          ADAPTACS.COM including any content, functionality and services offered
          on or through ADAPTACS.COM (the "<b>Website</b>"), whether as a guest
        ...
        <p className="leading-relaxed text-base pb-3">
          ...
          <b>
            ...
            these Terms of Use and our Privacy Policy, found at ADAPTA.EARTH,
            incorporated herein by reference.{" "}
          </b>
          If you do not wish to agree to these Terms of Use or the Privacy
        ...
        <p className="leading-relaxed text-base pb-3">
          ...
          <i>Privacy Policy</i>, and you consent to all actions we take with
        ...
        <h1 className="leading-relaxed text-base pb-3">
        ...
        <p className="leading-relaxed text-base pb-3">
          These Terms of Use permit you to use the Website for your personal or
          business use only. You must not reproduce, distribute, modify, create
          derivative works of, publicly display, publicly perform, republish,
          download, store or transmit any of the material on our Website, except
          as follows:
        </p>
        <li>
          <p className="leading-relaxed text-base pb-3">
        ...
        <li>
          ...
          <p className="leading-relaxed text-base pb-3">You must not:</p>
        </li>
        <li>
          <p
            style={{
        ...
        <li>
          ...
          <p className="leading-relaxed text-base pb-3">
            <a
              href="mailto:info@tiserincapital.com"
              className="a"
              target="_blank"
            >
            ...
            <a href="mailto:info@tiserincapital.com" target="_blank">
              info@tiserincapital.com
            </a>
          </p>
          ...
          <h1 className="leading-relaxed text-base pb-3">Trademarks</h1>
          ...
          <p className="leading-relaxed text-base pb-3"></p>
          <p className="s1" style={{ textIndent: "0pt", textAlign: "left" }}>
            Prohibited Uses
          </p>
          <p className="leading-relaxed text-base pb-3" />
        ...
        <li>
          ...
          <p className="leading-relaxed text-base pb-3">
            ...
            code, data mining software, "robot," "bot," "spider," "scraper" or
            other automatic device, or program, algorithm or methodology having
            similar processes or functionality, or any manual process, to
            monitor or copy any of the web pages, data or content found on this
            Website or accessed through this Website. You may not republish our
            content or other content from this Website on another website or use
            in-line or other linking to display such content without our
            permission. You may not introduce viruses, spyware or other
            malicious code to this Website. You represent and warrant that you
            use frequently updated, commercially standard virus protection
            software to ensure that the system you use to access our Website is
            virus free.
          </p>
          ...
          <p className="leading-relaxed text-base pb-3">
            ...
            pages or profiles, forums, blogs, news, bulletin boards and other
            interactive features (collectively, "<b>Interactive Services</b>")
            that allow users to post, submit, publish, display or transmit to
            other users or other persons (hereinafter, "<b>post</b>") content or
            materials (collectively, "<b>User Contributions</b>") on or through
            the Website.
          </p>
        ...
        <li>
          ...
          <p className="leading-relaxed text-base pb-3">
            However, we [cannot/do not undertake to] review [all] material
            before it is posted on the Website, and cannot ensure prompt removal
          ...
          <h1 className="leading-relaxed text-base pb-3">Content Standards</h1>
        ...
        <p className="leading-relaxed text-base pb-3">
          The owner of the Website is based in Washington DC in the United
        ...
        <p className="leading-relaxed text-base pb-3">
          You understand that we can not guarantee or warrant that files
        ...
        <p className="leading-relaxed text-base pb-3">
          ...
          violation of these Terms of Use or your use of the Website, including,
          but not limited to, your User Contributions, any use of the Website's
        ...
        <p className="leading-relaxed text-base pb-3">
          ...
          and construed in accordance with the internal laws of Washington DC]
          without giving effect to any choice or conflict of law provision or
          rule whether Washington DC or any other jurisdiction.
        </p>

        <p className="leading-relaxed text-base pb-3">
          Any legal suit, action or proceeding arising out of, or related to,
          these Terms of Use or the Website shall be instituted exclusively in
          the federal courts of the United States or the courts of Washington
          DC, in each case located in the City of Washington although we retain
          the right to bring any suit, action or proceeding against you for
        ...
        <p className="leading-relaxed text-base pb-3">
          At Tiserin Capital’s sole discretion, it may require You to submit any
          ...
          Arbitration Association applying Washington DC law.
        </p>
        <h1 className="pb-2 pt-2 text-lg font-medium text-gray-900 text-white">
        ...
        <p className="leading-relaxed text-base pb-3">
          This website is operated by Adapta Management based in Nairobi, Kenya.
        </p>

        <p className="leading-relaxed text-base pb-3">
          All notices of copyright infringement claims should be sent to the
          copyright agent designated in our Copyright Policy [INSERT AS LINK TO
          COPYRIGHT POLICY] in the manner and by the means set forth therein.
        </p>
